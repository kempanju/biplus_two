...
<div class="register_dv expert">
    <div class="center panel_div_list_big">
        ...
        <div class="col-lg-10 centered panel-body" style="margin-top: 20px">

            <g:uploadForm name="uploadUsers" controller="secUser" action="uploadCVUsers">

                <div class="col-lg-4 ">

                    <div class="col-lg-5 form-group">
                        <g:select name="user_group" id="user_group"  required="required"

                                  from="${admin.Customers.all}" optionKey="id" optionValue="name"
                                  class="form-control " noSelection="['': 'Select organization']"/>

                    </div>
                </div>

                <div class="col-lg-4">
                    <input type="file" name="uploadUsers"/>
                </div>


                <div class="text-right col-lg-3" >
                    <button type="submit" style="margin-left:4px"
                            class="btn btn-primary">Upload Users <i
                            class="icon-arrow-right14 position-right"></i>
                    </button>
                </div>
            </g:uploadForm>
