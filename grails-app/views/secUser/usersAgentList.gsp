...
<head>
    ...
    <script>
        ...
        function userSearch(ids) {
            ...
            $.ajax({
                url: '${grailsApplication.config.systemLink.toString()}/secUser/search_usehr',
        ...
        <div id="list-user" class="content scaffold-list" role="main">
            ...
            <table class="table datatable-basic">
                ...
                <tr>
                    ...
                    <g:sortableColumn property="agent_id"
                                      title="${message(code: 'company.name.label', default: 'Agent Name')}"/>
                    <g:sortableColumn property="agent_date"
                                      title="${message(code: 'company.name.label', default: 'Date')}"/>
                ...
                <g:each in="${secUserList}" status="i" var="userInstance">
                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'} ">
                        <td>
                            ...
                            ${i + 1 + offset}</td>
                        <td>
                    <g:link class="create" controller="secUser" action="show" id="${userInstance.id}">
                        ${userInstance.full_name}
                    </g:link>
                        </td>
                        ...
                        <td>
                            ...
                            <g:else>--}%
                            <g:link class="create" controller="secUser" action="show" id="${userInstance?.agent_id?.id}">
                                ${fieldValue(bean: userInstance, field: "agent_id.full_name")}

                            </g:link>
                        </td>
                        <td>
                            <g:formatDate format="dd-MMM-yyyy hh:mm a" date="${userInstance.agent_date}"/>
