 ...
 */
    def smsMtandaoSendMessagesLoan={ attrs, body ->
        ...
        try{
            ...
            def data = "kangombetz:pat_2023"
            String credentials = data.bytes.encodeBase64().toString()
            ...
            post.setDoOutput(true)
            post.setRequestProperty("Content-Type", "application/json")
            post.setRequestProperty("Authorization","Basic "+credentials)
