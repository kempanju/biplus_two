...
<html>
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h5>
                        <i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Add Region</span>
                    </h5>
                </div>
            </div>
        ...
        <div id="create-region" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.region}" method="POST" class="form-horizontal">
                <fieldset class="form">
                <g:render template="form" bean="region"/>
