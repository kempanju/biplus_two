    ...
    <span class="text-semibold">Repayment list</span></g:link>
                ...
                <div class="heading-elements">
                    <sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_DATA">
                        ...
                        <div class="col-md-4">
                            <g:link class="create" action="create" params="[user_id: userInstance.id]"><button type="button"
                                                                           class="btn bg-teal-400 btn-labeled"><b><i
                                        class="icon-add"></i></b> Add Repayment</button></g:link>
                        </div>
                    </sec:ifAnyGranted>
                    <div class="col-md-12">
                        ...
                        <%
                            ...
                            try {
                                ...
                                totals = loans.LoanRepayment.executeQuery("select sum (amount_paid) as total from LoanRepayment where user_id = : user_id",[user_id:userInstance])[0]
                                if(!totals){
                                    totals=0
                                }
