...
<div class="register_dv expert">
    ...
    <div class="center panel_div_list panel">
        ...
        <div class="page-header-content">
            ...
            <div class="heading-elements">
                ...
                <div class="col-md-12">
                    ...
                    <%
                        def totalRequest = loans.LoanRequest.executeQuery("select sum (amount) as total from LoanRequest where loan_status=2")[0]
                        if (!totalRequest) {
                            totalRequest = 0
                        }
        ...
        <div class="panel" style="margin-top: 100px">
            ...
            <div class="col-md-5">
                <g:link class="create" controller="loanRequest" action="printLoanExcel"><button type="button"
                                                                                                class="btn bg-teal-400 btn-labeled"><b><i
