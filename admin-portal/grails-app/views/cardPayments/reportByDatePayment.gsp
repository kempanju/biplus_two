        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                ...
                <div class="panel panel-flat">
                    ...
                    <%
                        def paidTotal=loans.CardPayments.executeQuery("from CardPayments where  created_at>='" + params.start_date + "' and created_at<='" + params.end_date + "'  ").size()
                                    ...
                                    <div class="panel-body">
                                        <h3 class="no-margin">
                                            <%
                                                def amountTotal=0
                                                try {
                                                    amountTotal = CardPayments.executeQuery("select sum (amount_paid) from CardPayments where  created_at>='" + params.start_date + "' and created_at<='" + params.end_date + "'")[0]
                                                    if(!amountTotal){
                                                        amountTotal=0;
                                                    }
                                                }catch (Exception e){
                                        ...
                                        <div class="text-muted text-size-small">
                                            na ${CardPayments.executeQuery("from CardPayments where  created_at>='" + params.start_date + "' and created_at<='" + params.end_date + "'").size()}
                                            transactions
                                        </div>
                                    </div>
                ...
                <div class="panel panel-flat">
                    ...
                    <div class="container-fluid" style="margin-top: 30px">
                        <table class="table datatable-basic">
                            ...
                            <g:each in="${CardPayments.executeQuery("select count(user_id.art_category_id),user_id.art_category_id.name,user_id.art_category_id.id from CardPayments where  created_at>='" + params.start_date + "' and created_at<='" + params.end_date + "' group by user_id.art_category_id")}" var="paymentInstance">
                ...
                <div class="panel panel-flat">
                    ...
                    <div class="container-fluid" style="margin-top: 30px">
                        <table class="table datatable-basic">
                            ...
                            <g:each in="${CardPayments.executeQuery("select count(user_id.recruitment_district),user_id.recruitment_district.name,user_id.recruitment_district.id from CardPayments where  created_at>='" + params.start_date + "' and created_at<='" + params.end_date + "' group by user_id.recruitment_district",[max:20])}" var="locationInstance">
                ...
                <div class="panel panel-flat">
                    ...
                    <div class="container-fluid" style="margin-top: 30px">
                        <table class="table datatable-basic">
                            ...
                            <g:each in="${CardPayments.executeQuery("select count(amount_paid),amount_paid from CardPayments where  created_at>='" + params.start_date + "' and created_at<='" + params.end_date + "' group by amount_paid",[max:20])}" var="amountInstance">
