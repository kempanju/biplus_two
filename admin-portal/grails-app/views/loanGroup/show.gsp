...
<html>
    ...
    <div class="register_dv expert">
        ...
        <div id="show-loanGroup" class="content scaffold-show" role="main">
            ...
            <f:display bean="loanGroup" />
           %{-- <g:form resource="${this.loanGroup}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.loanGroup}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
