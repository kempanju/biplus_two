<%@ page import="com.softhama.SecUser" %>
<!-- Main navbar -->
...
<sec:ifLoggedIn>
        ...
        <% def userInstance = SecUser.get(sec.loggedInUserInfo(field: 'id')) %>

        <h5 class="info_color">${userInstance?.customer?.name}</h5>
</sec:ifLoggedIn>
...
<sec:ifLoggedIn>
            ...
            <li class="dropdown dropdown-user">
                <a class="dropdown-toggle" data-toggle="dropdown">
                    <img src="${imagePathsProfile(name: "default_user.jpg")}" alt="">
